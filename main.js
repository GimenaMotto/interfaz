...
// // para recibir el contenido JSON y el número de factura y fecha

// ipcMain.on('load-data', (event, data) => {
//   const { jsonContent, lastNumberInput, invoiceDateInput } = data;
...
//     // Almacena la fecha
//     const invoiceDate = new Date(invoiceDateInput);
//     console.log('Fecha de la factura:', invoiceDate);
...
// // mostrar el diálogo de selección de directorio al recibir el evento 'select-directory'
// // Modifica el evento select-directory para obtener el valor del campo de entrada de texto del mes
// ipcMain.on('select-directory', (event, invoiceMonth, invoiceDateInput) => {
//   dialog.showOpenDialog(mainWindow, {
//     properties: ['openDirectory'],
//     title: 'Seleccione un directorio para guardar los PDFs',
//   }).then(result => {
...
//       const selectedDirectory = result.filePaths[0];
//       if (students.length > 0 && lastNumber !== null) {
//         // Pasa el invoiceMonth como argumento a la función generarPDF
//         generarPDF(students, lastNumber, selectedDirectory, invoiceDateInput, invoiceMonth);
//       } else {
//         console.error('Error: No se pueden generar los PDFs. Asegúrate de cargar los datos primero.');
//       }
//     }
